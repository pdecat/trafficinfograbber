...
public class ContactHelper {
	private static String getContactInformation(Activity activity, String contactUri, String column) {
		String result = null;
		...
		Log.d(dear2dear.TAG, "Retrieved contact '" + contactUri + "' information " + column + "=" + result);
